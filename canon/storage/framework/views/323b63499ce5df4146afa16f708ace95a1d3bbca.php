...
<div id="header">
    <div class="page-container" id="nav">
        <a href="index"><img src="images/login.png" style="float: left; padding-top:6px;"><a href="index" target="_self" class="hide-text"></a>
        ...
        <!--         <li><a href="/wiki"  target="_self">WIKI</a></li> -->
            ...
            <ul class="header-unlogin clearfix">
                <li class="header-app">
                    <a href="#" >
            <img src="images/phone.png"  style="padding-top:14px;"/>
                    </a>
