...
<script src="js/jquery-2.1.4.min.js" async="" charset="utf-8"></script>
  ...
  <!--未来几天天气状况测试结束  END-->
    ...
    <div class="statics clearfix">
      <div class="static-item ">
        <span class="meta-value"><strong><?php echo 123?></strong></span>
...
<div class="course-info-main clearfix w">
  <div class="info-bar clearfix">
    <div class="info-bar-box">
                ...
                <a href="shiti" class="btn-red start-study-btn r">继续学习</a>
        ...
        <div class="outline-list">
                  ...
                  <div class="chapter-bd l">
                     {{-- <h5 class="name">第1章 Java初体验</h5>--}}
                      <p class="desc"></p>
                       <h3 class="ctit">教学视频：</h3>
                      <video class='video'  src="" width='500' height='300' style="margin-left:100px;background:#33ffff">
                      </video>
                  </div>
                </li>
                          </ul>
          ...
          <p class="person_num"><em>1337</em>位同学参与评价</p>
            ...
            <div class="evaluation-con" id="list">
              ...
              <div class="content-box">
                  ...
                  <a href="#" class="username"><?php echo 123?></a>
                  <div class="star-box">
                      <img src="images/xing.jpg" width="20" height="20">
                      <img src="images/xing.jpg" width="20" height="20">
                      <img src="images/xing.jpg" width="20" height="20">
                ...
                <p class="content"><?php echo 123?></p>
                <div class="info">
                  <span class="time">时间：<?php echo 123?></span>
                </div>
              </div>
